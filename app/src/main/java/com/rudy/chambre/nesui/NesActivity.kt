...
import com.rudy.chambre.Bibliotheque
import com.rudy.chambre.Rom
...
import com.rudy.chambre.nes.AutoTest

class NesActivity : ComponentActivity() {
    ...
    private val choisirDossier = registerForActivityResult(
        ...
        if (uri == null) return@registerForActivityResult
        Bibliotheque.retenir(this, "nes", uri)
        ouvrirCatalogue()
    }
    ...
    private fun ouvrirCatalogue() {
        ...
        if (Bibliotheque.dossier(this, "nes") == null) { choisirDossier.launch(null); return }
        Toast.makeText(this, "Lecture du dossier…", Toast.LENGTH_SHORT).show()
        Thread {
            val roms = Bibliotheque.lister(this, "nes")
            runOnUiThread {
        ...
        val curseur = SeekBar(this).apply {
            ...
            setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
                ...
                override fun onStopTrackingTouch(sb: SeekBar) {
                    Dispositions.poserOpacite(this@NesActivity, vue.opaciteBoutons)
                }
            })
        }
    ...
    private fun construireBarre(): HorizontalScrollView {
        ...
        bouton("Dossier") { Bibliotheque.oublier(this, "nes"); choisirDossier.launch(null) }
