...
import com.rudy.chambre.nes.Ines
import com.rudy.chambre.nes.Nes
import com.rudy.chambre.nes.Pad as PadNes
...
class CoeurNes : NesCore, Coeur {
    ...
    override val romChargee: Boolean get() = console != null
    override val pret: Boolean get() = true
    override val imagesParSeconde: Double get() = 60.0988

    /** Identifie la ROM en cours : sert a nommer son fichier de sauvegarde. */
    override var cle: String = ""
        private set
    ...
    override fun sauverEtat(): ByteArray? = console?.sauverEtat()

    override fun restaurerEtat(donnees: ByteArray): Boolean = console?.restaurerEtat(donnees) ?: false
    ...
    override fun son(): ShortArray = console?.son() ?: ShortArray(0)
