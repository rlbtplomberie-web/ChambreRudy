...
import com.rudy.chambre.ps1ui.core.CoeurPs1
import com.rudy.chambre.ps1ui.core.Pad
...
class SkinView(ctx: Context) : View(ctx) {
    ...
    private fun chargerSkin(dossier: String, cible: HashMap<String, Touche>): Bitmap {
        val texte = context.assets.open("skins/ps1/skin/$dossier/positions.json").bufferedReader().use { it.readText() }
