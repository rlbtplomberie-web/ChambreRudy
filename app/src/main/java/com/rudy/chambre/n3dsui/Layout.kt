...
class Disposition(val sw: Float, val sh: Float, val items: MutableMap<String, Rect4>,
    ...
    companion object {
        ...
        fun depuisSkin(ctx: Context, dossier: String): Disposition {
            val texte = ctx.assets.open("skins/3ds/skin/$dossier/positions.json").bufferedReader().use { it.readText() }
...
object Dispositions {
     ...
     * l'ecran du bas seul.
     *
     * Sur 3DS, l'ecran du haut fait 400 sur 240 et celui du bas 320 sur 240 :
     * c'est le rapport de chaque dalle du skin qui dit lequel elle represente.
     */
    val PAYSAGES = listOf(
        ...
        Habillage("paysage_un_large", "Écran du haut",
            Rect4(471f, 121f, 869f, 578f), null),
        Habillage("paysage_un_carre", "Écran du bas",
            null, Rect4(479f, 78f, 855f, 642f)),
    )
