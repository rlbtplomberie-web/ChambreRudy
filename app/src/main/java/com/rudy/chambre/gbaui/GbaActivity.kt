 ...
 * L'application.
 *
 * Elle assemble le coeur mGBA et l'habillage qui dessine la console.
 ...
 */
class GbaActivity : ComponentActivity() {
    ...
    private val prefs by lazy {
        getSharedPreferences("skingba", Context.MODE_PRIVATE)
    }
        ...
        ligneOpacite.addView(SeekBar(this).apply {
            ...
            setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
                ...
                override fun onStopTrackingTouch(sb: SeekBar) {
                    Dispositions.poserOpacite(this@GbaActivity, vue.opaciteBoutons)
                }
            })
    ...
    private fun extraire(uri: Uri, nom: String): File? {
        ...
        if (sorties.isEmpty() && entrees > 0)
            throw IllegalStateException(
                "Cette archive ne contient aucun jeu Game Boy Advance " +
        ...
        for (c in codes) {
            ll.addView(CheckBox(this).apply {
                ...
                setOnCheckedChangeListener { _, v ->
                    c.actif = v
                    Triches.enregistrer(this@GbaActivity, jeu, codes)
                }
                setOnLongClickListener {
                    android.app.AlertDialog.Builder(this@GbaActivity)
            ...
            addView(bouton("Défaut") {
                android.app.AlertDialog.Builder(this@GbaActivity)
                    ...
                    .setPositiveButton("Rétablir") { _, _ ->
                        ...
                        Toast.makeText(this@GbaActivity, "Rétabli",
                                       Toast.LENGTH_SHORT).show()
                    }
                    .setNegativeButton("Annuler", null)
                    .show()
