...
import com.skinds.app.core.CoeurDS
import java.io.File
...
class MainActivity : ComponentActivity() {
    ...
    private fun changerPresentation() {
        ...
        val h = com.skinds.app.Dispositions.habillage(true, vue.rangPaysage)
    ...
    private fun appliquerQualite(n: Int) {
        val nb = com.skinds.app.core.CoeurDS.RESOLUTIONS.size
        ...
        noter("résolution interne demandée : " +
              com.skinds.app.core.CoeurDS.LIBELLES[qualite - 1])
        bQualite.text = com.skinds.app.core.CoeurDS.LIBELLES[qualite - 1]
    }
    ...
    private fun relancerPourQualite() {
        val f = jeuCourant
        val res = com.skinds.app.core.CoeurDS.LIBELLES[qualite - 1]
