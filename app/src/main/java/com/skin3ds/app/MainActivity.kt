...
class MainActivity : ComponentActivity() {
    ...
    private fun changerPresentation() {
        ...
        val h = com.skin3ds.app.Dispositions.habillage(true, vue.rangPaysage)
    ...
    private fun appliquerQualite(n: Int) {
        val nb = com.skin3ds.app.core.Coeur3DS.RESOLUTIONS.size
        ...
        noter("résolution interne demandée : " +
              com.skin3ds.app.core.Coeur3DS.LIBELLES[qualite - 1])
        bQualite.text = com.skin3ds.app.core.Coeur3DS.LIBELLES[qualite - 1]
    }
    ...
    private fun relancerPourQualite() {
        val f = jeuCourant
        val res = com.skin3ds.app.core.Coeur3DS.LIBELLES[qualite - 1]
