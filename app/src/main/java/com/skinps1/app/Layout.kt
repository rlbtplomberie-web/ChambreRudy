...
object Ids {
    ...
    const val HAUT = "haut"; const val BAS = "bas"; const val GAUCHE = "gauche"; const val DROITE = "droite"
    const val TRIANGLE = "triangle"; const val ROND = "rond"; const val CARRE = "carre"; const val CROIX = "croix"
    const val SELECT = "select"; const val START = "start"
    const val L1 = "L1"; const val L2 = "L2"; const val R1 = "R1"; const val R2 = "R2"
    const val STICK_G = "stickG"; const val STICK_D = "stickD"
    const val FF = "ff"
    const val MENU = "menu"; const val JEUX = "jeux"; const val QUIT = "quit"
    ...
    val FONCTIONS = listOf(MENU, JEUX, QUIT, MANETTE)
...
class Disposition(val sw: Float, val sh: Float, val items: MutableMap<String, Rect4>,
    ...
    companion object {
        ...
        fun depuisSkin(ctx: Context, dossier: String, ecran: Rect4): Disposition {
            val texte = ctx.assets.open("ps1/skin/$dossier/positions.json").bufferedReader().use { it.readText() }
...
object Dispositions {
    ...
    private val ECRAN_PORTRAIT = Rect4(35f, 143f, 782f, 839f)
    private val ECRAN_PAYSAGE = Rect4(402f, 87f, 1042f, 636f)
    /**
     * Grand ecran de la seconde presentation horizontale.
     *
     * Legerement rentre par rapport a la dalle mesuree — (328, 2, 1186, 850) —
     * pour que l'image ne deborde jamais du cadre dessine.
     */
    private val ECRAN_PAYSAGE_LARGE = Rect4(334f, 8f, 1174f, 838f)
    /**
    ...
    private const val PREFS = "skin_ps1"
     ...
     * grand ecran. Le bouton manette fait passer de l'une a l'autre, et la
