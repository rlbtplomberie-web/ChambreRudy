...
object Bibliotheque {
    ...
    private const val PREFS = "skin_n64"
    private const val CLE_DOSSIER = "dossier_roms"
    private val EXTENSIONS = listOf(".sfc", ".smc", ".fig", ".swc", ".zip")
    ...
    /**
     * Liste les ROMs Nintendo 64 du dossier, sous-dossiers compris.
