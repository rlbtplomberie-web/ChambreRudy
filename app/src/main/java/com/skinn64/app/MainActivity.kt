    ...
    private fun chargerDepuis(uri: Uri) {
        ...
        try {
            ...
            if (estZip(octets)) {
                ...
                if (dedans == null) {
                    Toast.makeText(this, "Archive sans ROM Nintendo 64", Toast.LENGTH_LONG).show()
                    return
                }
                octets = dedans
            }
    ...
    private fun ouvrirCatalogue() {
        ...
        Thread {
            ...
            runOnUiThread {
                ...
                if (roms.isEmpty()) {
                    Toast.makeText(this, "Aucune ROM Nintendo 64 dans ce dossier", Toast.LENGTH_LONG).show()
    ...
    override fun onCreate(s: Bundle?) {
        ...
        if (!coeur.pret) {
            android.app.AlertDialog.Builder(this)
                ...
                .setMessage(coeur.derniereErreur + "\n\nLe fichier libmupen64plus.so doit être présent dans l'APK. " +
                            "Vérifie l'étape « Récupérer le coeur Mupen64Plus » du workflow.")
