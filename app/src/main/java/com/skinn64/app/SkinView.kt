...
import com.skinn64.app.core.CoeurSnes
import com.skinn64.app.core.Pad
...
class SkinView(ctx: Context) : View(ctx) {
    ...
    private fun chargerSkin(dossier: String, cible: HashMap<String, Touche>): Bitmap {
        val texte = context.assets.open("n64/skin/$dossier/positions.json").bufferedReader().use { it.readText() }
