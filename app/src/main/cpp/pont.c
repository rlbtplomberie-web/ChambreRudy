...
Java_com_rudy_chambre_core_CoeurLibretro_natInit(JNIEnv *env, jobject self, jstring chemin, jstring dossier) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_core_CoeurLibretro_natCharger(JNIEnv *env, jobject self, jbyteArray rom) {
    (void)self;
...
Java_com_rudy_chambre_core_CoeurLibretro_natImage(JNIEnv *env, jobject self, jint boutons, jintArray sortie) {
    (void)self;
...
JNIEXPORT jint JNICALL
Java_com_rudy_chambre_core_CoeurLibretro_natSon(JNIEnv *env, jobject self, jshortArray sortie) {
    (void)self;
    jsize cap = (*env)->GetArrayLength(env, sortie);
...
Java_com_rudy_chambre_core_CoeurLibretro_natFrequence(JNIEnv *env, jobject self) {
    (void)env; (void)self; return g_sample_rate;
}

JNIEXPORT jdouble JNICALL
Java_com_rudy_chambre_core_CoeurLibretro_natFps(JNIEnv *env, jobject self) {
    (void)env; (void)self; return g_fps;
}

JNIEXPORT void JNICALL
Java_com_rudy_chambre_core_CoeurLibretro_natReset(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (g_charge) p_reset();
}

JNIEXPORT void JNICALL
Java_com_rudy_chambre_core_CoeurLibretro_natEjecter(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (g_charge) { p_unload_game(); g_charge = false; }
...
Java_com_rudy_chambre_core_CoeurLibretro_natSauver(JNIEnv *env, jobject self) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_core_CoeurLibretro_natRestaurer(JNIEnv *env, jobject self, jbyteArray donnees) {
    (void)self;
