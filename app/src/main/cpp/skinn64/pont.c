...
Java_com_skinn64_app_core_CoeurSnes_natInit(JNIEnv *env, jobject self, jstring chemin, jstring dossier) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_skinn64_app_core_CoeurSnes_natCharger(JNIEnv *env, jobject self, jbyteArray rom) {
    (void)self;
...
Java_com_skinn64_app_core_CoeurSnes_natImage(JNIEnv *env, jobject self, jint boutons, jintArray sortie) {
    (void)self;
...
JNIEXPORT jint JNICALL
Java_com_skinn64_app_core_CoeurSnes_natSon(JNIEnv *env, jobject self, jshortArray sortie) {
    (void)self;
    jsize cap = (*env)->GetArrayLength(env, sortie);
...
Java_com_skinn64_app_core_CoeurSnes_natFrequence(JNIEnv *env, jobject self) {
    (void)env; (void)self; return g_sample_rate;
}

JNIEXPORT jdouble JNICALL
Java_com_skinn64_app_core_CoeurSnes_natFps(JNIEnv *env, jobject self) {
    (void)env; (void)self; return g_fps;
}

JNIEXPORT void JNICALL
Java_com_skinn64_app_core_CoeurSnes_natReset(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (g_charge) p_reset();
}

JNIEXPORT void JNICALL
Java_com_skinn64_app_core_CoeurSnes_natEjecter(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (g_charge) { p_unload_game(); g_charge = false; }
...
Java_com_skinn64_app_core_CoeurSnes_natSauver(JNIEnv *env, jobject self) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_skinn64_app_core_CoeurSnes_natRestaurer(JNIEnv *env, jobject self, jbyteArray donnees) {
    (void)self;
