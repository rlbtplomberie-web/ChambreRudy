...
Java_com_skindc_app_core_CoeurDc_natInit(JNIEnv *env, jobject self, jstring chemin,
...
Java_com_skindc_app_core_CoeurDc_natVariable(JNIEnv *env, jobject self, jstring cle, jstring val) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_skindc_app_core_CoeurDc_natGlInit(JNIEnv *env, jobject self, jint w, jint h) {
    (void)env; (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_skindc_app_core_CoeurDc_natGlTaille(JNIEnv *env, jobject self, jint w, jint h) {
    (void)env; (void)self;
...
Java_com_skindc_app_core_CoeurDc_natGlImage(JNIEnv *env, jobject self, jint boutons,
...
JNIEXPORT jboolean JNICALL
Java_com_skindc_app_core_CoeurDc_natCharger(JNIEnv *env, jobject self, jstring chemin) {
    (void)self;
...
JNIEXPORT jint JNICALL
Java_com_skindc_app_core_CoeurDc_natLirePixels(JNIEnv *env, jobject self, jintArray sortie) {
    (void)self;
...
JNIEXPORT jint JNICALL
Java_com_skindc_app_core_CoeurDc_natSon(JNIEnv *env, jobject self, jshortArray sortie) {
    (void)self;
    jsize cap = (*env)->GetArrayLength(env, sortie);
...
JNIEXPORT jint JNICALL
Java_com_skindc_app_core_CoeurDc_natMaxL(JNIEnv *e, jobject s) { (void)e; (void)s; return (jint)g_maxw; }
JNIEXPORT jint JNICALL
Java_com_skindc_app_core_CoeurDc_natMaxH(JNIEnv *e, jobject s) { (void)e; (void)s; return (jint)g_maxh; }

JNIEXPORT jdouble JNICALL Java_com_skindc_app_core_CoeurDc_natFrequence(JNIEnv *e, jobject s) { (void)e; (void)s; return g_sample_rate; }
JNIEXPORT jdouble JNICALL Java_com_skindc_app_core_CoeurDc_natFps(JNIEnv *e, jobject s) { (void)e; (void)s; return g_fps; }
JNIEXPORT void JNICALL Java_com_skindc_app_core_CoeurDc_natReset(JNIEnv *e, jobject s) { (void)e; (void)s; if (g_charge) p_reset(); }

JNIEXPORT void JNICALL
Java_com_skindc_app_core_CoeurDc_natEjecter(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (g_charge) { p_unload_game(); g_charge = false; }
    g_son_n = 0;
}
...
JNIEXPORT jboolean JNICALL
Java_com_skindc_app_core_CoeurDc_natTricheDispo(JNIEnv *e, jobject s) {
    (void)e; (void)s;
...
JNIEXPORT jint JNICALL
Java_com_skindc_app_core_CoeurDc_natMemoireTaille(JNIEnv *e, jobject s) {
    (void)e; (void)s;
...
JNIEXPORT void JNICALL
Java_com_skindc_app_core_CoeurDc_natTricheVider(JNIEnv *e, jobject s) {
...
JNIEXPORT void JNICALL
Java_com_skindc_app_core_CoeurDc_natTricheAjouter(JNIEnv *env, jobject self,
...
Java_com_skindc_app_core_CoeurDc_natSauver(JNIEnv *env, jobject self) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_skindc_app_core_CoeurDc_natRestaurer(JNIEnv *env, jobject self, jbyteArray donnees) {
    (void)self;
