/*
 * Pont entre l'application et le coeur Gambatte, au format libretro.
 *
 ...
 *
 * Les codes de triche passent par retro_cheat_set, que Gambatte comprend au
...
Java_com_gbgbc_app_core_Coeur_natInit(JNIEnv *env, jobject self, jstring chemin,
                                       jstring dossier) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_gbgbc_app_core_Coeur_natCharger(JNIEnv *env, jobject self, jstring jeu) {
    (void)self;
...
Java_com_gbgbc_app_core_Coeur_natDecharger(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (!g_charge) return;
...
JNIEXPORT void JNICALL
Java_com_gbgbc_app_core_Coeur_natImage(JNIEnv *env, jobject self, jint boutons) {
    (void)env; (void)self;
    if (!g_charge) return;
    g_boutons = boutons;
...
Java_com_gbgbc_app_core_Coeur_natLireImage(JNIEnv *env, jobject self, jintArray sortie) {
    (void)self;
...
JNIEXPORT jint JNICALL
Java_com_gbgbc_app_core_Coeur_natSonLire(JNIEnv *env, jobject self, jshortArray sortie) {
    (void)self;
    jsize cap = (*env)->GetArrayLength(env, sortie);
 ...
 * Les codes de triche.
 *
 * Gambatte accepte le format Game Genie — quatre caracteres, un tiret, trois,
 * un tiret, deux — et le format GameShark, huit caracteres. On les lui passe
 * tels quels : c'est lui qui les interprete.
 */
JNIEXPORT void JNICALL
Java_com_gbgbc_app_core_Coeur_natTrichesEffacer(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (p_cheat_reset) p_cheat_reset();
}

JNIEXPORT void JNICALL
Java_com_gbgbc_app_core_Coeur_natTricheAjouter(JNIEnv *env, jobject self,
...
JNIEXPORT jboolean JNICALL
Java_com_gbgbc_app_core_Coeur_natTrichesPossibles(JNIEnv *e, jobject s) {
    (void)e; (void)s;
...
JNIEXPORT void JNICALL
Java_com_gbgbc_app_core_Coeur_natVariable(JNIEnv *env, jobject self,
...
JNIEXPORT void JNICALL
Java_com_gbgbc_app_core_Coeur_natReinitialiser(JNIEnv *e, jobject s) {
    (void)e; (void)s;
    if (g_charge) p_reset();
}

JNIEXPORT jdouble JNICALL
Java_com_gbgbc_app_core_Coeur_natImagesParSeconde(JNIEnv *e, jobject s) {
    (void)e; (void)s; return g_fps;
}

JNIEXPORT jint JNICALL
Java_com_gbgbc_app_core_Coeur_natFrequence(JNIEnv *e, jobject s) {
    (void)e; (void)s; return (jint)g_sample_rate;
}

JNIEXPORT jint JNICALL
Java_com_gbgbc_app_core_Coeur_natClarte(JNIEnv *e, jobject s) {
    (void)e; (void)s; return (jint)g_clarte;
}

JNIEXPORT jint JNICALL
Java_com_gbgbc_app_core_Coeur_natImagesEmulees(JNIEnv *e, jobject s) {
    (void)e; (void)s; return (jint)(g_images & 0x7FFFFFFF);
}

JNIEXPORT jbyteArray JNICALL
Java_com_gbgbc_app_core_Coeur_natSauver(JNIEnv *env, jobject self) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_gbgbc_app_core_Coeur_natRestaurer(JNIEnv *env, jobject self, jbyteArray etat) {
    (void)self;
