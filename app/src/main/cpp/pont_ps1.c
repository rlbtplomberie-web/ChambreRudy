...
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natInit(JNIEnv *env, jobject self, jstring chemin, jstring dossier) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natCharger(JNIEnv *env, jobject self, jstring chemin) {
    (void)self;
...
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natVariable(JNIEnv *env, jobject self, jstring cle, jstring val) {
    (void)self;
...
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natImage(JNIEnv *env, jobject self, jint boutons,
...
JNIEXPORT jint JNICALL
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natSon(JNIEnv *env, jobject self, jshortArray sortie) {
    (void)self;
    jsize cap = (*env)->GetArrayLength(env, sortie);
...
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natFrequence(JNIEnv *env, jobject self) {
    (void)env; (void)self; return g_sample_rate;
}

JNIEXPORT jdouble JNICALL
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natFps(JNIEnv *env, jobject self) {
    (void)env; (void)self; return g_fps;
}

JNIEXPORT void JNICALL
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natReset(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (g_charge) p_reset();
}

JNIEXPORT void JNICALL
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natEjecter(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (g_charge) { p_unload_game(); g_charge = false; }
...
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natSauver(JNIEnv *env, jobject self) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_ps1ui_core_CoeurPs1_natRestaurer(JNIEnv *env, jobject self, jbyteArray donnees) {
    (void)self;
