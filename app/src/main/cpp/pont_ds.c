...
Java_com_rudy_chambre_dsui_core_CoeurDS_natInit(JNIEnv *env, jobject self, jstring chemin,
...
Java_com_rudy_chambre_dsui_core_CoeurDS_natVariable(JNIEnv *env, jobject self, jstring cle, jstring val) {
    (void)self;
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natGlInit(JNIEnv *env, jobject self, jint w, jint h) {
    (void)env; (void)self;
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natGlTaille(JNIEnv *env, jobject self, jint w, jint h) {
    (void)env; (void)self;
...
Java_com_rudy_chambre_dsui_core_CoeurDS_natGlImage(JNIEnv *env, jobject self, jint boutons,
...
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natCharger(JNIEnv *env, jobject self, jstring chemin) {
    (void)self;
...
JNIEXPORT jint JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natLirePixels(JNIEnv *env, jobject self, jintArray sortie) {
    (void)self;
    if (!g_charge) return 0;
...
JNIEXPORT void JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natStylet(JNIEnv *e, jobject s, jfloat fx, jfloat fy) {
    (void)e; (void)s;
...
JNIEXPORT void JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natSonVider(JNIEnv *e, jobject s) {
    (void)e; (void)s;
    pthread_mutex_lock(&g_son_verrou);
    g_son_n = 0;
    pthread_mutex_unlock(&g_son_verrou);
...
JNIEXPORT jint JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natSon(JNIEnv *env, jobject self, jshortArray sortie) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natRenduMateriel(JNIEnv *e, jobject s) {
    (void)e; (void)s; return g_hw_demande ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jint JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natMaxL(JNIEnv *e, jobject s) { (void)e; (void)s; return (jint)g_maxw; }
JNIEXPORT jint JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natMaxH(JNIEnv *e, jobject s) { (void)e; (void)s; return (jint)g_maxh; }

JNIEXPORT jdouble JNICALL Java_com_rudy_chambre_dsui_core_CoeurDS_natFrequence(JNIEnv *e, jobject s) { (void)e; (void)s; return g_sample_rate; }
JNIEXPORT jdouble JNICALL Java_com_rudy_chambre_dsui_core_CoeurDS_natFps(JNIEnv *e, jobject s) { (void)e; (void)s; return g_fps; }
JNIEXPORT void JNICALL Java_com_rudy_chambre_dsui_core_CoeurDS_natReset(JNIEnv *e, jobject s) { (void)e; (void)s; if (g_charge) p_reset(); }

JNIEXPORT void JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natEjecter(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (g_charge) { p_unload_game(); g_charge = false; }
    g_son_n = 0;
}
...
Java_com_rudy_chambre_dsui_core_CoeurDS_natSauver(JNIEnv *env, jobject self) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_dsui_core_CoeurDS_natRestaurer(JNIEnv *env, jobject self, jbyteArray donnees) {
    (void)self;
