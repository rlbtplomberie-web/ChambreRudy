...
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natInit(JNIEnv *env, jobject self, jstring chemin,
...
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natVariable(JNIEnv *env, jobject self, jstring cle, jstring val) {
    (void)self;
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natGlInit(JNIEnv *env, jobject self, jint w, jint h) {
    (void)env; (void)self;
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natGlTaille(JNIEnv *env, jobject self, jint w, jint h) {
    (void)env; (void)self;
...
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natGlImage(JNIEnv *env, jobject self, jint boutons,
...
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natCharger(JNIEnv *env, jobject self, jstring chemin) {
    (void)self;
...
JNIEXPORT jint JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natLirePixels(JNIEnv *env, jobject self, jintArray sortie) {
    (void)self;
    if (!g_charge) return 0;
...
JNIEXPORT void JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natStylet(JNIEnv *e, jobject s, jfloat fx, jfloat fy) {
    (void)e; (void)s;
...
JNIEXPORT void JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natSonVider(JNIEnv *e, jobject s) {
    (void)e; (void)s;
    pthread_mutex_lock(&g_son_verrou);
    g_son_n = 0;
    pthread_mutex_unlock(&g_son_verrou);
...
JNIEXPORT jint JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natSon(JNIEnv *env, jobject self, jshortArray sortie) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natRenduMateriel(JNIEnv *e, jobject s) {
    (void)e; (void)s; return g_hw_demande ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jint JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natMaxL(JNIEnv *e, jobject s) { (void)e; (void)s; return (jint)g_maxw; }
JNIEXPORT jint JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natMaxH(JNIEnv *e, jobject s) { (void)e; (void)s; return (jint)g_maxh; }

JNIEXPORT jdouble JNICALL Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natFrequence(JNIEnv *e, jobject s) { (void)e; (void)s; return g_sample_rate; }
JNIEXPORT jdouble JNICALL Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natFps(JNIEnv *e, jobject s) { (void)e; (void)s; return g_fps; }
JNIEXPORT void JNICALL Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natReset(JNIEnv *e, jobject s) { (void)e; (void)s; if (g_charge) p_reset(); }

JNIEXPORT void JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natEjecter(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (g_charge) {
        /* On annonce au coeur que son contexte graphique disparait. Sans cette
           annonce il gardait toutes ses ressources, et le chargement suivant
...
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natSauver(JNIEnv *env, jobject self) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_rudy_chambre_n3dsui_core_Coeur3DS_natRestaurer(JNIEnv *env, jobject self, jbyteArray donnees) {
    (void)self;
