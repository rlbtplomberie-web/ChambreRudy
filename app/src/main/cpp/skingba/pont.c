/*
 * Pont entre l'application et le coeur mGBA, au format libretro.
 *
 ...
 *
 * Les codes de triche passent par retro_cheat_set, que mGBA comprend au
...
Java_com_skingba_app_core_Coeur_natInit(JNIEnv *env, jobject self, jstring chemin,
                                       jstring dossier) {
    (void)self;
    ...
    var_poser("mgba_color_correction", "OFF");
    var_poser("mgba_frameskip", "disabled");
    var_poser("mgba_idle_optimization", "Remove Known");
    var_poser("mgba_use_bios", "ON");
    var_poser("mgba_skip_bios", "OFF");
    var_poser("mgba_sgb_borders", "OFF");
...
JNIEXPORT jboolean JNICALL
Java_com_skingba_app_core_Coeur_natCharger(JNIEnv *env, jobject self, jstring jeu) {
    (void)self;
...
Java_com_skingba_app_core_Coeur_natDecharger(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (!g_charge) return;
...
JNIEXPORT void JNICALL
Java_com_skingba_app_core_Coeur_natImage(JNIEnv *env, jobject self, jint boutons) {
    (void)env; (void)self;
    if (!g_charge) return;
    g_boutons = boutons;
...
Java_com_skingba_app_core_Coeur_natLireImage(JNIEnv *env, jobject self, jintArray sortie) {
    (void)self;
...
JNIEXPORT jint JNICALL
Java_com_skingba_app_core_Coeur_natSonLire(JNIEnv *env, jobject self, jshortArray sortie) {
    (void)self;
    jsize cap = (*env)->GetArrayLength(env, sortie);
 ...
 * Les codes de triche.
 *
 * mGBA accepte les codes GameShark, Action Replay et CodeBreaker. On les lui
 * passe tels quels : c'est lui qui reconnait le format et les interprete.
 */
JNIEXPORT void JNICALL
Java_com_skingba_app_core_Coeur_natTrichesEffacer(JNIEnv *env, jobject self) {
    (void)env; (void)self;
    if (p_cheat_reset) p_cheat_reset();
}

JNIEXPORT void JNICALL
Java_com_skingba_app_core_Coeur_natTricheAjouter(JNIEnv *env, jobject self,
...
JNIEXPORT jboolean JNICALL
Java_com_skingba_app_core_Coeur_natTrichesPossibles(JNIEnv *e, jobject s) {
    (void)e; (void)s;
...
JNIEXPORT void JNICALL
Java_com_skingba_app_core_Coeur_natVariable(JNIEnv *env, jobject self,
...
JNIEXPORT void JNICALL
Java_com_skingba_app_core_Coeur_natReinitialiser(JNIEnv *e, jobject s) {
    (void)e; (void)s;
    if (g_charge) p_reset();
}

JNIEXPORT jdouble JNICALL
Java_com_skingba_app_core_Coeur_natImagesParSeconde(JNIEnv *e, jobject s) {
    (void)e; (void)s; return g_fps;
}

JNIEXPORT jint JNICALL
Java_com_skingba_app_core_Coeur_natFrequence(JNIEnv *e, jobject s) {
    (void)e; (void)s; return (jint)g_sample_rate;
}

JNIEXPORT jint JNICALL
Java_com_skingba_app_core_Coeur_natClarte(JNIEnv *e, jobject s) {
    (void)e; (void)s; return (jint)g_clarte;
}

JNIEXPORT jint JNICALL
Java_com_skingba_app_core_Coeur_natImagesEmulees(JNIEnv *e, jobject s) {
    (void)e; (void)s; return (jint)(g_images & 0x7FFFFFFF);
}

JNIEXPORT jbyteArray JNICALL
Java_com_skingba_app_core_Coeur_natSauver(JNIEnv *env, jobject self) {
    (void)self;
...
JNIEXPORT jboolean JNICALL
Java_com_skingba_app_core_Coeur_natRestaurer(JNIEnv *env, jobject self, jbyteArray etat) {
    (void)self;
